...
| --- | --- | --- | --- |
| Docs (this) | `docs/agy-system-message-scrub` | **docs draft PR (fill after open)** | Spec, tickets, this README, delivery-note placeholders |
| Code | `feat/agy-system-message-scrub` | **code draft PR (fill after open)** | Product code + tests only |
...
2. Claim on the **docs** PR (status / comment). Read-only claim.
