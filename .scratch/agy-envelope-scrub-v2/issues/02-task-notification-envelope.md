...
- [ ] Translator both emission paths covered via the shared module.
- [ ] Tests red-then-green acceptable as one or two commits on the same code PR; `pnpm ci:local` green.
- [ ] Delivery note filled; no Spec/scratch on the code PR.
