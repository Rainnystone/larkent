...
beforeEach(async () => {
  ...
  await saveRootConfig(
    createRootConfig('claude', createDefaultProfileConfig({ agentKind: 'claude', mode: 'personal', accounts: { app } })),
    configPath,
  );
  ...
  rc.profiles.work = createDefaultProfileConfig({ agentKind: 'claude', mode: 'personal', accounts: { app: { ...app, id: 'cli_work' } } });
